...
st.title('🔴⚪⚫ Vitin CEP — Busca Rápida e Fácil')
...
st.sidebar.title('🔴⚪⚫ Vitin CEP — Busca Rápida e Fácil')
st.sidebar.image("logo1.png", width=400)
escolha = st.sidebar.selectbox("Escolha uma das opções :",opcoes)
